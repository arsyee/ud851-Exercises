...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private static final int GITHUB_SEARCH_LOADER = 243;
    ...
    private void makeGithubSearchQuery() {
        ...
        if ("".equals(githubQuery)) {
            Toast.makeText(this, "There is nothing to search for", Toast.LENGTH_LONG).show();
            return;
        }
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                ...
                if (searchUrlString == null || searchUrlString.isEmpty()) return null;
                // COMPLETED (12) Copy the try / catch block from the AsyncTask's doInBackground method
                String githubSearchResults = null;
                try {
                    githubSearchResults = NetworkUtils.getResponseFromHttpUrl(new URL(searchUrlString));
                } catch (IOException e) {
                    e.printStackTrace();
                }
    ...
    public void onLoadFinished(Loader<String> loader, String data) {
        ...
        String githubSearchResults = data;
