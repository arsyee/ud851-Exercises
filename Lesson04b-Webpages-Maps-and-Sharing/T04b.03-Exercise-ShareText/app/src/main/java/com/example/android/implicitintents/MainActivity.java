...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String textToShare = "Udacity course rulz!";
    ...
    private void shareText(String text) {
        ...
        String chooserTitle = "Share text";
        // COMPLETED (4) Use ShareCompat.IntentBuilder to build the Intent and start the chooser
        ShareCompat.IntentBuilder.from(this).setChooserTitle(chooserTitle).setType(mimeType).setText(text).startChooser();
    }
}