...
public class NotificationUtils {
    ...
    private static final int ACTION_INCREMENT_WATER_COUNT_PENDING_INTENT_ID = 3419;
    /**
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_cancel_black_24px, context.getString(R.string.dismiss), pendingIntent);
        //      COMPLETED (10) Return the action
        Log.d(TAG, "ignore action created");
        return action;
    }
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        Intent launchWaterReminder = new Intent(context, WaterReminderIntentService.class);
        //      COMPLETED (13) Set the action of the intent to designate you want to increment the water count
        launchWaterReminder.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
        //      COMPLETED (14) Create a PendingIntent from the intent to launch WaterReminderIntentService
        PendingIntent pendingIntent = PendingIntent.getService(context, ACTION_INCREMENT_WATER_COUNT_PENDING_INTENT_ID, launchWaterReminder, PendingIntent.FLAG_UPDATE_CURRENT);
        //      COMPLETED (15) Create an Action for the user to tell us they've had a glass of water
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_local_drink_black_24px, context.getString(R.string.increment), pendingIntent);
        //      COMPLETED (16) Return the action
        Log.d(TAG, "didit action created");
        return action;
    }
