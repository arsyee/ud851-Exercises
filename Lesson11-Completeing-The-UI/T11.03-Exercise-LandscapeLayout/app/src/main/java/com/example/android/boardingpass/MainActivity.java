...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        // COMPETED (7) Use the flightInfor attribute in mBinding below to get the appropiate text Views
        mBinding.lFlightInfo.textViewOriginAirport.setText(info.originCode);
        mBinding.lFlightInfo.textViewFlightCode.setText(info.flightCode);
        mBinding.lFlightInfo.textViewDestinationAirport.setText(info.destCode);
        ...
        mBinding.lBoardingInfo.textViewTerminal.setText(info.departureTerminal);
        mBinding.lBoardingInfo.textViewGate.setText(info.departureGate);
        mBinding.lBoardingInfo.textViewSeat.setText(info.seatNumber);
    }
}
