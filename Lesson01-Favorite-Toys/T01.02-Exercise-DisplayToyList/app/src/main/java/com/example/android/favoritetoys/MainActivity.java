...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StringBuilder toyNamesBuilder = new StringBuilder();
        for (String toyName : toyNames) {
            if (toyNamesBuilder.length() != 0) toyNamesBuilder.append("\n");
            toyNamesBuilder.append(toyName);
        }
        mToysListTextView.setText(toyNamesBuilder.toString());
    }
}