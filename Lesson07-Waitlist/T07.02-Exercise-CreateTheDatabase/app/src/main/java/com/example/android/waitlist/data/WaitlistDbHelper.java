...
public class WaitlistDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String SQL_CREATE_WAITLIST_TABLE = "CREATE TABLE " + WaitlistEntry.TABLE_NAME + "( " +
                WaitlistEntry._ID + " INT PRIMARY KEY, " +
                WaitlistEntry.COLUMN_GUEST_NAME + " VARCHAR(255) NOT NULL, " +
                WaitlistEntry.COLUMN_PARTY_SIZE + " INT NOT NULL, " +
                WaitlistEntry.COLUMN_TIMESTAMP + " TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP);";
